...
from resourceful.codegen import sort_resources_topological
...
def test_library_url_default_publisher_signature():
    ...
    assert needed.library_url(foo) == '/resourceful/foo'
...
def test_library_url_script_name():
    ...
    assert needed.library_url(foo) == '/root/resourceful/foo'
...
<html><head>something more<link rel="stylesheet" type="text/css" href="/resourceful/foo/b.css" />
<script type="text/javascript" src="/resourceful/foo/a.js"></script>
<script type="text/javascript" src="/resourceful/foo/c.js"></script></head></html>'''
...
def test_html_insert_head_with_attributes():
    ...
    assert needed.render_into_html(html) == b'''\
<html><head profile="http://example.org">something<script type="text/javascript" src="/resourceful/foo/a.js"></script></head></html>'''
...
<link rel="stylesheet" type="text/css" href="/resourceful/foo/b.css" />
<script type="text/javascript" src="/resourceful/foo/a.js"></script>
<script type="text/javascript" src="/resourceful/foo/y2.js"></script>
<script type="text/javascript" src="/resourceful/foo/c.js"></script>'''
    assert bottom == ''
...
def test_html_bottom_safe_used_with_minified():
    ...
    assert bottom == ('<script type="text/javascript" '
                      'src="/resourceful/foo/a-minified.js"></script>')
...
<html><head>start of head<link rel="stylesheet" type="text/css" href="/resourceful/foo/b.css" /></head><body>rest of body<script type="text/javascript" src="/resourceful/foo/a.js"></script>
<script type="text/javascript" src="/resourceful/foo/c.js"></script></body></html>'''
...
def test_register_inclusion_renderer():
    ...
    needed = NeededResources()
    needed.need(a)
    assert needed.render() == ('<link rel="unknown" href="/resourceful/foo/nothing.unknown" />')
...
def test_registered_inclusion_renderers_in_order():
    ...
    assert needed.render() == """\
<link rel="stylesheet" type="text/css" href="/resourceful/foo/something.css" />
<script type="text/javascript" src="/resourceful/foo/something.js"></script>
<link rel="shortcut icon" type="image/x-icon" href="/resourceful/foo/something.ico"/>
<unknown href="/resourceful/foo/nothing.later"/>"""

    register_inclusion_renderer('.sooner', render_unknown, 5)
    e = Resource(foo, 'nothing.sooner')
    needed.need(e)
    assert needed.render() == """\
<unknown href="/resourceful/foo/nothing.sooner"/>
<link rel="stylesheet" type="text/css" href="/resourceful/foo/something.css" />
<script type="text/javascript" src="/resourceful/foo/something.js"></script>
<link rel="shortcut icon" type="image/x-icon" href="/resourceful/foo/something.ico"/>
<unknown href="/resourceful/foo/nothing.later"/>"""
...
<link rel="stylesheet" type="text/css" href="/resourceful/foo/something.css" />
<script type="text/javascript" src="/resourceful/foo/something.js"></script>
<unknown href="/resourceful/foo/nothing.between"/>
<link rel="shortcut icon" type="image/x-icon" href="/resourceful/foo/something.ico"/>
<unknown href="/resourceful/foo/nothing.later"/>"""
...
def test_custom_renderer_for_resource():
    foo = Library('foo', '')
    from resourceful.core import render_print_css

    a = Resource(foo, 'printstylesheet.css', renderer=render_print_css)
    needed = NeededResources()
    needed.need(a)
    assert needed.render() == """\
<link rel="stylesheet" type="text/css" href="/resourceful/foo/printstylesheet.css" media="print" />"""
    ...
    assert needed.render() == """\
<link rel="stylesheet" type="text/css" href="/resourceful/foo/printstylesheet.css" media="print" />
<unknown href="/resourceful/foo/nothing.unknown"/>"""
...
def test_custom_renderer_keep_together():
    ...
    assert needed.render() == """\
<link rel="stylesheet" type="text/css" href="/resourceful/foo/printstylesheet.css" media="print"/>
<link rel="stylesheet" type="text/css" href="/resourceful/foo/regular.css" />
<script type="text/javascript" src="/resourceful/foo/something.js"></script>"""
...
def test_resource_subclass_render():
    ...
    needed.need(a)
    assert needed.render() == """\
<myresource reference="/resourceful/foo/printstylesheet.css"/>"""
...
def test_check_resource_dependencies():
    ...
    # https://bitbucket.org/resourceful/resourceful/issue/63
...
<link rel="stylesheet" type="text/css" href="/resourceful/foo/:bundle:a.css;b.css" />''', '')

    needed = NeededResources(resources=[a, b], bundle=True, bottom=True)
    assert needed.render_topbottom() == ('''\
<link rel="stylesheet" type="text/css" href="/resourceful/foo/a.css" />''', '''\
<link rel="stylesheet" type="text/css" href="/resourceful/foo/b.css" />''')
