...
from resourceful import (Library, Resource, Injector, get_needed,
                       NEEDED)
...
def test_needed_deleted_after_request():
    ...
    # been processed by resourceful's inclusion rendering.
    dummy = get_needed()
    with pytest.raises(NotImplementedError):
        dummy.clear()
...
def test_can_handle_no_content():
    ...
    def app(environ, start_response):
        ...
        # https://bitbucket.org/resourceful/resourceful/issue/49/exception-in-injector-when-app-returns-304
