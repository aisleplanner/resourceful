...
from resourceful.core import bundle_resources, Bundle
...
def test_render_bundle():
    ...
    assert needed.render() == '''<link rel="stylesheet" type="text/css" href="/resourceful/foo/a.css" />
<link rel="stylesheet" type="text/css" href="/resourceful/foo/b.css" />
<link rel="stylesheet" type="text/css" href="/resourceful/foo/c.css" />'''

    needed = NeededResources(resources=[x1, x2, x3], bundle=True)
    assert needed.render() == '''<link rel="stylesheet" type="text/css" href="/resourceful/foo/:bundle:a.css;b.css" />
<link rel="stylesheet" type="text/css" href="/resourceful/foo/c.css" />'''
    ...
    assert needed.render() == '''<link rel="stylesheet" type="text/css" href="/resourceful/foo/:bundle:a.css;b.css" />
<link rel="stylesheet" type="text/css" href="/resourceful/foo/subdir/subdir/:bundle:x4.css;x5.css" />'''
